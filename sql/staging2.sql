...
LOAD DATA LOCAL INFILE '/Users/gregor/Documents/OneDrive/Documents/Jaenoo/Personen/pd_dump.csv' INTO TABLE STAGING.stg_personen FIELDS TERMINATED BY '|';
...
select count(*) from STAGING.stg_personen;
-- 565'927
